...
class AppPallete {
  ...
  static const Color backgroundColor = Color(0xFF15131C);  // Dark blue-gray background
  ...
  static const Color containerColor = Color(0xFF2D2F3E);  // Medium dark blue-gray
  ...
  static const Color focusColor = Color(0xFF2C2F3F);  // Slightly lighter than background
